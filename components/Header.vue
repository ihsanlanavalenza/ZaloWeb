<template>
  <header class="fixed top-0 left-0 right-0 z-50 px-4 py-4">
    <nav class="container mx-auto">
      <div class="flex items-center justify-between px-6 py-4 rounded-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
        <!-- Logo -->
        ...
        <div class="hidden md:flex items-center gap-3">
          <button 
            ...
            class="p-2.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300"
          ...
          <button class="px-5 py-2 rounded-full font-medium text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300">
            Sign In
          </button>
          <button class="px-5 py-2 rounded-full font-medium text-sm text-white bg-gray-900 dark:bg-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-300">
            Sign Up
          </button>
        </div>
      ...
      <div v-show="mobileMenuOpen" class="md:hidden mt-4 px-6 py-4 rounded-3xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
        ...
        <div class="flex flex-col gap-2 pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
          <button class="w-full px-6 py-2.5 rounded-full font-medium text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
            Sign In
          </button>
          <button class="w-full px-6 py-2.5 rounded-full font-medium text-sm text-white bg-gray-900 dark:bg-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 transition-all">
            Sign Up
          </button>
        </div>
      </div>
