      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="space-y-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="flex items-center gap-3 glass-card p-4 rounded-xl shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
              <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-blue-500/50">
        ...
        <div class="relative lg:h-[600px] flex items-center justify-center">
          <div class="relative z-10 glass-card rounded-3xl p-8 shadow-2xl max-w-md w-full premium-shadow">
            <div class="space-y-6">
              <div class="flex items-center gap-2 pb-4 border-b border-gray-200">
                ...
                <div class="flex-1 bg-gray-100 rounded-lg px-3 py-1 text-xs text-gray-500 font-medium">www.yourwebsite.com</div>
              </div>

              <div class="space-y-4">
                <div class="h-32 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shine-effect">
                  <svg class="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
                  </svg>
                </div>
                <div class="space-y-2">
                  <div class="h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded animate-pulse"></div>
                  <div class="h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-3/4 animate-pulse"></div>
                </div>
                <div class="grid grid-cols-3 gap-3">
                  <div class="h-20 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg shadow-sm hover:shadow-md transition-shadow"></div>
                  <div class="h-20 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg shadow-sm hover:shadow-md transition-shadow"></div>
                  <div class="h-20 bg-gradient-to-br from-pink-100 to-pink-200 rounded-lg shadow-sm hover:shadow-md transition-shadow"></div>
                </div>
                <div class="flex gap-2">
                  <div class="flex-1 h-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-md"></div>
                  <div class="flex-1 h-8 bg-gray-200 rounded-lg"></div>
                </div>
              </div>
            </div>
          </div>
          <div class="absolute top-10 -left-10 w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl rotate-12 animate-float shadow-2xl shadow-blue-500/50 opacity-80"></div>
          <div class="absolute bottom-20 -right-10 w-24 h-24 bg-gradient-to-br from-purple-400 to-blue-500 rounded-full animate-float-delayed shadow-2xl shadow-purple-500/50 opacity-80"></div>
          <div class="absolute top-1/2 -right-20 w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl -rotate-12 animate-float shadow-2xl shadow-blue-500/50 opacity-80"></div>
        </div>
      </div>
    </div>
  </section>
