  ...
  <section class="py-16 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="text-center mb-12">
        <p class="text-gray-600 text-sm uppercase tracking-wider mb-2">Trusted By</p>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
        ...
        <div class="glass-card p-6 rounded-2xl flex items-center justify-center h-24 hover:scale-105 transition-transform group">
          <div class="text-center">
            ...
            <p class="text-xs text-gray-600">Technology</p>
          </div>
        </div>
        ...
        <div class="glass-card p-6 rounded-2xl flex items-center justify-center h-24 hover:scale-105 transition-transform group">
          <div class="text-center">
            ...
            <p class="text-xs text-gray-600">Healthcare</p>
          </div>
        </div>
        ...
        <div class="glass-card p-6 rounded-2xl flex items-center justify-center h-24 hover:scale-105 transition-transform group">
          <div class="text-center">
            ...
            <p class="text-xs text-gray-600">Finance</p>
          </div>
        </div>
      </div>
      ...
      <div class="mt-12 text-center">
        <p class="text-gray-600 text-sm">
          Melayani berbagai industri di <span class="font-semibold text-gray-900">Jakarta, Bandung, Surabaya, Bali</span> dan kota-kota lainnya
        </p>
      </div>
    </div>
  </section>
...
<script setup>
// Komponen untuk menampilkan trust badge berupa industri klien
// Bisa diganti dengan logo asli client ketika sudah ada
</script>
